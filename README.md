# 📡 Channel Alert Bot — بوت تنبيهات توفر دزرت

بوت تيليغرام يراقب موقع **دزرت** بشكل مستمر ويُرسل إشعارات فورية لقنوات تيليغرام المخصصة عند توفر أي منتج أو نفاده، مع إدارة طلبات الانضمام ومراقبة انتهاء الاشتراكات.
...
- 🛡️ حماية من Cloudflare عبر `cloudscraper`
